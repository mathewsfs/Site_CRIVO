...
import { ArrowRight, Users, MessageSquare, Calendar, BarChart3 } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
              Transform your business with a complete management platform.
            </p>
            <div className="mt-8">
              <Button size="lg">
                Get Started
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">Why Choose Bitrix24?</h2>
          </div>
          <div className="mt-10">
